...
-   [context](https://docs.qwsoftware.com/docs/manual/job-workflows.html#context-variables) variable, such as project, job, node
-   data variable captured by a [key-value](https://docs.qwsoftware.com/docs/manual/log-filters/key-value-data.html), Multiline regex, or JQ log filter
