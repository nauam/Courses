...
via an SSH command or via the [rd adhoc](https://qwsoftware.github.io/qwcontrol-cli/commands/#adhoc) shell tool.
...
[rd adhoc](https://qwsoftware.github.io/qwcontrol-cli/commands/#adhoc)
~ Execute ad hoc commands and scripts to matching nodes.

[rd executions](https://qwsoftware.github.io/qwcontrol-cli/commands/#executions)
