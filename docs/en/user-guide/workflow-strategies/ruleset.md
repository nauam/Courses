...
:::tip
The [3.4.4 release](/en/history/3_4_x/version-3.4.4.md) of QW Control Enterprise includes updates to our incubating feature for visualizing the workflow strategy.
:::
...
![Ruleset Strategy](/en/@assets/img/relnotes-344-rulesetdesigner.gif)
