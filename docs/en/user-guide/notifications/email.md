...
- **Attached as file to email**: put the log output as an attached file.
  ...
  See [Email Settings: Custom Attached Log Output File](/en/administration/configuration/email-settings.md#custom-attached-log-output-file) above.
...
- [Email Settings](/en/administration/configuration/email-settings)
- [Email Settings: Custom Email Templates](/en/administration/configuration/email-settings.md#custom-email-templates)
