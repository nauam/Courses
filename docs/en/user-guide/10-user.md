...
The email address can be referenced as a [context variable](/en/user-guide/job-workflows.md#context-variables)
from Job notifications as `${job.user.email}`.

The email address and name will also be used by SCM plugins for commit identification.  (See: [Git Plugin - Committer Configuration](/en/administration/projects/scm/git.md#committer-configuration)).
...
For information on configuring Authentication see [Administration Guide - Authenticating Users](/en/administration/security/authentication.html#authenticating-users).
