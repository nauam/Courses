...
:::tip
It is helpful configure the Oracle Cloud Infrastructure (OCI) resource model plugin before using these steps: [Oracle Cloud Resource Model](/en/administration/projects/resource-model-sources/orale.md)
:::
