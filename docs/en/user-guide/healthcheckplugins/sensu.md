...
Before creating the health check, have the API key and URL for the account ready. To find them, see [here](/en/https://docs.sensu.io/sensu-go/latest/api/apikeys/#create-a-new-api-key).
