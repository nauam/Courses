...
To add nodes to your QW Control instances, see [Configure - Resource Model Sources Configuration](/en/administration/projects/resource-model-sources/)
...
6. Health Status - an indication of the Health Status of the Node (see [Health Checks](/en/user-guide/healthchecks.md)).
...
For full syntax information see the [Node Filters](/en/user-guide/11-node-filters.md) chapter.
...
The saved filters become available in the Filters menu in other parts of QW Control, like in the Nodes page, when creating Jobs or running Commands.
...
[rd nodes](/en/https://qwsoftware.github.io/qwcontrol-cli/commands/#nodes)
