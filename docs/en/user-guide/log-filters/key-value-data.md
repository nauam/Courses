...
the [Multiline Regex Capture](/en/user-guide/log-filters/multi-line-regex.html#usage) plugin.
:::
...
![](/en/@assets/img/logfilter-keyvalue-example1.png)

The log filter in this example is fully default, with the Log Data field checked:

![](/en/@assets/img/logfilter-keyvalue-example2.png)

The output when the job runs looks like this:

![](/en/@assets/img/logfilter-keyvalue-example3.png)
