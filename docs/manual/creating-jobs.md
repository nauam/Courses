...
::: tip
By default, the "Matched Nodes" section will show a maximum of 100 nodes in the search result. To customize this maximum value, you should set the property `qwcontrol.gui.matchedNodesMaxCount` on qwcontrol-config.property file
:::
