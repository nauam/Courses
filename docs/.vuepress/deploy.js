...
if (TAG) {
    ...
    env = {
        QWCONTROL_VERSION: version,
        QWCONTROL_VERSION_FULL: `${version}-${date}`
    }
...
function syncS3(base) {
    ...
    CP.execSync(`aws s3 sync --acl public-read docs/.vuepress/dist/ s3://docs.qwcontrol.com/${base}/`, { stdio: "inherit" })
}