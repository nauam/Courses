module.exports = [{
    ...
    children: [
        ...
        },
        {
            title: 'Installation',
            collapsable: true,
            path: '/administration/install/installing-qwcontrol',
            sidebarDepth: 1,
            children: [
                '/administration/install/installing-qwcontrol',
        ...
        },
        {
            ...
            children: [
                '/upgrading/upgrading',
                '/upgrading/upgrading-toqwcontrol3',
            ]
        },
        {
            title: 'Licensing',
        ...
        },
        {
            ...
            children: [
                ...
                '/administration/maintenance/tuningqwcontrol'
            ]
        },
        {
            title: 'Clustering',
